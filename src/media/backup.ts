/**
 * Library backups: strict parsing of a media version 1 file, and a merge that
...
export function parseBackup(value: unknown): Library {
  const source = record(value);
  if (source.version !== 1) throw new InputError("Choose a media version 1 library backup.");
