    ...
    <div className="mx-auto max-w-[1040px] pb-10">
      ...
      {stage === 'upload' && <div className="mt-9 grid gap-10 lg:grid-cols-[minmax(0,1fr)_270px] lg:gap-12">
        <section aria-labelledby="upload-heading">
          ...
          <p className="mt-4 text-xs leading-6 text-muted-foreground">Your file is sent to the Vistara server to match its titles. You’ll review the results before anything is added.</p>
